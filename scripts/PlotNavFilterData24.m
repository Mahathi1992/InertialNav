...
figure;
subplot(3,1,1);
plot(time_est,dVelBiasX_est*50);
hold on;
plot(time_est,(dVelBiasX_est+sqrt(variance_est(:,14)))*50,'r:');
plot(time_est,(dVelBiasX_est-sqrt(variance_est(:,14)))*50,'r:');
hold off
grid on;
...
subplot(3,1,2);
plot(time_est,dVelBiasY_est*50);
hold on;
plot(time_est,(dVelBiasY_est+sqrt(variance_est(:,16)))*50,'r:');
plot(time_est,(dVelBiasY_est-sqrt(variance_est(:,16)))*50,'r:');
hold off
grid on;
xlabel('time (sec)');ylabel('Y bias (m/s^2)');
subplot(3,1,3);
plot(time_est,dVelBiasZ_est*50);
hold on;
plot(time_est,(dVelBiasZ_est+sqrt(variance_est(:,16)))*50,'r:');
plot(time_est,(dVelBiasZ_est-sqrt(variance_est(:,16)))*50,'r:');
hold off
grid on;
...
hold on;
plot(time_est,(velWN_est+sqrt(variance_est(:,17))),'r:');
plot(time_est,(velWN_est-sqrt(variance_est(:,17))),'r:');
hold off
grid on;
xlabel('time (sec)');ylabel('North Velocity (m/s)');
...
hold on;
plot(time_est,(velWE_est+sqrt(variance_est(:,18))),'r:');
plot(time_est,(velWE_est-sqrt(variance_est(:,18))),'r:');
hold off
grid on;
xlabel('time (sec)');ylabel('East Velocity (m/s)');
...
hold on;
plot(time_est,(magN_est+sqrt(variance_est(:,19))),'r:');
plot(time_est,(magN_est-sqrt(variance_est(:,19))),'r:');
hold off
grid on;
...
hold on;
plot(time_est,(magE_est+sqrt(variance_est(:,20))),'r:');
plot(time_est,(magE_est-sqrt(variance_est(:,20))),'r:');
hold off
grid on;
...
hold on;
plot(time_est,(magD_est+sqrt(variance_est(:,21))),'r:');
plot(time_est,(magD_est-sqrt(variance_est(:,21))),'r:');
hold off
grid on;
...
hold on;
plot(time_est,(magX_est+sqrt(variance_est(:,22))),'r:');
plot(time_est,(magX_est-sqrt(variance_est(:,22))),'r:');
hold off
grid on;
...
hold on;
plot(time_est,(magY_est+sqrt(variance_est(:,23))),'r:');
plot(time_est,(magY_est-sqrt(variance_est(:,23))),'r:');
hold off
grid on;
...
hold on;
plot(time_est,(magZ_est+sqrt(variance_est(:,24))),'r:');
plot(time_est,(magZ_est-sqrt(variance_est(:,23))),'r:');
hold off
grid on;
